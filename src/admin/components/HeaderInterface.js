 ...
 * @param  { BOOLEAN } result Boolean verify result superior four
 * Return string
 */
export function HeaderInterface(result) {
  //~ If result superior a four next exist
  let next = result
    ? `
      <article id="next"><h1>See next</h1>
  ...
  return `
    <header>
      <p>${ContentsAdmin.categories.p}</p>
      <article id="add"><h1>Add One</h1>
